...
const Project = ({
    ...
    useEffect(() => {
        fetch('https://api.codenavid.ir/api/projects?populate=*')
            .then(res => res.json())
            .then(data => {
            ...
            {projectData && projectData.map(item => {
                ...
                >
                    ...
                    <div className="w-full">
                        <a href={`https://api.codenavid.ir${item.attributes.image.data.attributes.url}`}>
                        ...
                        <div className="flex gap-2 mt-2">
                            <img
                                src={`https://api.codenavid.ir${item.attributes.icon.data.attributes.url}`}
