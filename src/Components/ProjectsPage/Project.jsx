        ...
        <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {projectData && projectData.map(item => {
                ...
                >
                    ...
                    >
                        <img
                            src={`https://my-portfolio.chbk.run${item.attributes.image.data.attributes.url}`}
                    ...
                    <div className="w-full">
                        <a href={`https://my-portfolio.chbk.run${item.attributes.image.data.attributes.url}`}>
                        ...
                        <div className="flex gap-2 mt-2">
                            <img
                                src={`https://my-portfolio.chbk.run${item.attributes.icon.data.attributes.url}`}
